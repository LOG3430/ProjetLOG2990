# LOG3430 - Reconnaissance et remerciement 

Nous remercions les étudiants de LOG2990 qui ont accepté de nous prêter leur code à titre d'exemple pour le cours de LOG3430 ainsi que le maitre d'enseignement Nikolay Radoev pour sa contribution et participation. 

Le code a été modifié afin de remplir les objectifs pédagogiques de LOG3430. Pour le déploiement, nous utilisons [Docker Compose](https://docs.docker.com/compose/). Le projet peut aussi être démarré en local sans l'utilisation de Docker, à condition de modifier les fichiers .env nécessaire et d'avoir une instance mongodb local ou sur Docker.

La très grande majorité des fichiers ont été laissés tel quel sans aucune modification, dont la suite du README plus bas. 
